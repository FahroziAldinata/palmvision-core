...
<template>
    ...
    <AuthenticatedLayout>
            ...
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-xs text-emerald-700 dark:text-emerald-400">
                        Rekapitulasi hasil panen harian per blok dengan rincian
                        per pemanen
                    </p>
                </div>
                <Link
                        ...
                        >
                            ...
                            >
                                ...
                                <tr v-if="produksiList.data.length === 0">
                                    ...
                                    >
                                        Belum ada rekaman produksi harian yang
                                        dicatat.
                                    </td>
                                </tr>
                            </tbody>
        ...
        >
            <div
                class="w-full max-w-lg rounded-2xl border border-gray-100 bg-white p-6 shadow-xl dark:border-gray-700 dark:bg-gray-800"
            >
                <div
                ...
                >
                    <div>
                        ...
                        >
                            Rincian Pemanen Blok
                            {{ selectedProduksi.blok?.kode_blok }}
                        </h3>
                        <p class="text-xs text-gray-500 dark:text-gray-400">
                            Tanggal: {{ selectedProduksi.tanggal }} • Total:
                            {{
                                Number(
                                    selectedProduksi.total_berat_kg,
                                ).toLocaleString('id-ID')
                            }}
                            Kg
                        </p>
                ...
                <div class="mt-4 max-h-80 overflow-y-auto">
                    <table
                        class="w-full text-left text-xs text-gray-600 dark:text-gray-300"
                    >
                        <thead
                        ...
                        >
                            <tr
                                v-for="d in selectedProduksi.details"
                                :key="d.id"
                            >
                                <td class="px-3 py-2 font-mono font-semibold">
                                    {{ d.pemanen?.kode_pemanen || '-' }}
                                </td>
                                ...
                                <td
                                    class="px-3 py-2 text-right font-mono font-semibold text-emerald-700 dark:text-emerald-400"
                                >
                ...
                <div
                    v-if="selectedProduksi.catatan"
                    class="mt-4 rounded-lg bg-gray-50 p-3 text-xs text-gray-600 dark:bg-gray-900/50 dark:text-gray-400"
                >
                    <span class="font-semibold">Catatan:</span>
                    {{ selectedProduksi.catatan }}
                </div>
